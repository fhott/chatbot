(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lime-js"));
	else if(typeof define === 'function' && define.amd)
		define(["Lime"], factory);
	else if(typeof exports === 'object')
		exports["MessagingHubClient"] = factory(require("lime-js"));
	else
		root["MessagingHubClient"] = factory(root["Lime"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _limeJs = __webpack_require__(1);
	...
	var MessagingHubClient = function () {
	    _createClass(MessagingHubClient, [{
	        key: 'uri',
	        get: function get() {
	            return this._uri;
	        }
	    ...
	    function MessagingHubClient(uri, transport) {
	        var _this = this;
	
	        _classCallCheck(this, MessagingHubClient);
	
	        this._uri = uri;
	        this._transport = transport;
	        this._clientChannel = new _limeJs2.default.ClientChannel(this._transport, true, true);
	        ...
	        this._clientChannel.onMessage = function (message) {
	            _this._messageReceivers.forEach(function (receiver) {
	                if (receiver.predicate(message)) {
	                    try {
	                        _this.sendNotification({ id: message.id, to: message.from, event: _limeJs2.default.NotificationEvent.RECEIVED });
	                        receiver.callback(message);
	                        _this.sendNotification({ id: message.id, to: message.from, event: _limeJs2.default.NotificationEvent.CONSUMED });
	                    } catch (e) {
	    ...
	    _createClass(MessagingHubClient, [{
	        ...
	        value: function connectWithGuest(identifier) {
	            ...
	            return this._transport.open(this.uri).then(function () {
	                var authentication = new _limeJs2.default.GuestAuthentication();
	                return _this2._clientChannel.establishSession(_limeJs2.default.SessionEncryption.NONE, _limeJs2.default.SessionCompression.NONE, identifier + '@msging.net', authentication, '');
	            }).then(function (session) {
	                return _this2._sendPresenceCommand().then(function () {
	                    return session;
	                });
	            }).then(function (session) {
	                return _this2._sendReceiptsCommand().then(function () {
	                    return session;
	                });
	            });
	        }
	        ...
	        value: function connectWithPassword(identifier, password) {
	            var _this3 = this;
	
	            if (!identifier) throw new Error('The identifier is required');
	            if (!password) throw new Error('The password is required');
	            return this._transport.open(this.uri).then(function () {
	                var authentication = new _limeJs2.default.PlainAuthentication();
	                authentication.password = _jsBase.Base64.encode(password);
	                return _this3._clientChannel.establishSession(_limeJs2.default.SessionEncryption.NONE, _limeJs2.default.SessionCompression.NONE, identifier + '@msging.net', authentication, '');
	            }).then(function (session) {
	                return _this3._sendPresenceCommand().then(function () {
	                    return session;
	                });
	            }).then(function (session) {
	                return _this3._sendReceiptsCommand().then(function () {
	                    return session;
	                });
	            });
	        }
	        ...
	        key: 'connectWithKey',
	        value: function connectWithKey(identifier, key) {
	            var _this4 = this;
	
	            if (!identifier) throw new Error('The identifier is required');
	            if (!key) throw new Error('The key is required');
	            return this._transport.open(this.uri).then(function () {
	                var authentication = new _limeJs2.default.KeyAuthentication();
	                authentication.key = key;
	                return _this4._clientChannel.establishSession(_limeJs2.default.SessionEncryption.NONE, _limeJs2.default.SessionCompression.NONE, identifier + '@msging.net', authentication, '');
	            }).then(function (session) {
	                return _this4._sendPresenceCommand().then(function () {
	                    return session;
	                });
	            });
	        }
	        ...
	        value: function sendCommand(command) {
	            ...
	            return new Promise(function (resolve, reject) {
	                _this5._commandResolves[command.id] = function (c) {
	                    if (c.status && c.status === _limeJs2.default.CommandStatus.SUCCESS) {
	                        resolve(c);
	                    } else {
	                        reject(c);
	                    }
	                    delete _this5._commandResolves[command.id];
	                };
	            });
	        }
	        ...
	        value: function addMessageReceiver(predicate, callback) {
	            ...
	            return function () {
	                return _this6._messageReceivers = _this6._messageReceivers.filter(function (r) {
	        ...
	        value: function addNotificationReceiver(predicate, callback) {
	            ...
	            return function () {
	                return _this7._notificationReceivers = _this7._notificationReceivers.filter(function (r) {
	                    return r.predicate !== predicate && r.callback !== callback;
	                });
	            };
	        }
	...
	exports.default = MessagingHubClient;
